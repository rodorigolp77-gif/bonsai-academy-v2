...
import { FaSearch, FaDollarSign } from 'react-icons/fa'; // Importa os ícones
...
function OverdueStudents({ navigate }) { 
    ...
    useEffect(() => {
        const fetchOverdueStudents = async () => {
            try {
                ...
                console.error("Erro ao buscar alunos com pagamentos atrasados:", err);
                setError("Não foi possível carregar a lista de alunos com pagamentos atrasados.");
                setLoading(false);
            }
        };
    ...
    return (
        <div style={messageBoxContainerStyle}>
                ...
                {overdueStudents.map(student => (
                    <li key={student.id} style={listItemStyle}>
                        ...
                        <div style={buttonGroupStyle}>
                            ...
                            <button
                                onClick={() => navigate(`/payments/${student.id}`)}
            ...
            <button onClick={handleCloseBox} style={closeButtonStyle}>
                Fechar
            </button>
        </div>
    );
